...
export async function POST(request: Request) {
  try {
    ...
    const { athleteName, parentName, parentEmail, sessionId, sessionDate, trainer } = body;
    ...
    const resolvedSessionId = sessionId === "aug27" ? "aug27" : "aug12";
    const resolvedDate = sessionDate || "Wednesday, August 12";
    const resolvedTrainer = trainer || "Prime Motion Athletics";
    ...
    if (process.env.NEXT_PUBLIC_SUPABASE_URL && process.env.SUPABASE_SERVICE_ROLE_KEY) {
      ...
      await supabase.from("camp_registrations").insert({
        ...
        camp_id: `blueprint-workshop-${resolvedSessionId}`,
        camp_name: `Blueprint Workshop — ${resolvedDate} (${resolvedTrainer})`,
        amount: "$79.99",
    ...
    if (process.env.RESEND_API_KEY) {
      ...
      await Promise.all([
          ...
          html: `
            <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#000;line-height:1.6;">
              <div style="background:#000;padding:28px 32px;border-radius:16px 16px 0 0;">
                ...
                <p style="color:rgba(255,255,255,0.5);font-size:12px;margin:6px 0 0;">Featuring ${resolvedTrainer}</p>
              </div>
              ...
              <div style="background:#f9f9f9;padding:28px 32px;">
                ...
                <div style="background:#fff;border:1px solid #e5e5e5;border-radius:12px;padding:20px;margin:24px 0;">
                  ...
                  <table style="width:100%;border-collapse:collapse;font-size:14px;">
                    ...
                    <tr><td style="padding:6px 0;color:#666;">Session</td><td style="padding:6px 0;font-weight:700;">Featuring ${resolvedTrainer}</td></tr>
                    <tr><td style="padding:6px 0;color:#666;">Date</td><td style="padding:6px 0;font-weight:700;">${resolvedDate}, 2026</td></tr>
              ...
              <div style="background:#f0f0f0;padding:16px 32px;border-radius:0 0 16px 16px;text-align:center;">
                <p style="font-size:11px;color:#999;margin:0;">Blueprint Workshop · ${resolvedDate}, 2026 · Featuring ${resolvedTrainer}</p>
              </div>
            </div>
          `,
        }),
        ...
        resend.emails.send({
          ...
          subject: `🏀 NEW WORKSHOP REG: ${athleteName} — ${resolvedDate}`,
          html: `
            ...
            <table style="font-family:sans-serif;font-size:14px;border-collapse:collapse;">
              ...
              <tr><td style="padding:6px 16px 6px 0;color:#666;">Session</td><td style="padding:6px 0;">Featuring ${resolvedTrainer}</td></tr>
              <tr><td style="padding:6px 16px 6px 0;color:#666;">Date</td><td style="padding:6px 0;">${resolvedDate}, 2026 · 12:00–3:00 PM</td></tr>
